...
# tiation-white-rabbit-ngo - Enterprise Deployment Script
# Project Type: ngo-platform
...
PROJECT_NAME="tiation-white-rabbit-ngo"
PROJECT_TYPE="ngo-platform"
DEFAULT_DOMAIN="tiation-white-rabbit.surge.sh"
FEATURES="donation-processing,campaign-management,social-impact,transparency"
